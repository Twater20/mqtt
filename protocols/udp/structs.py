...
class CommandHead(ctypes.Structure):
    ...
    _fields_ = [
        ("code", ctypes.c_uint32),  # 指令码
        ("parameters_size", ctypes.c_uint32),  # 指令值大小
        ("type", ctypes.c_uint32),  # 指令类型: 0=简单指令, 1=复杂指令
    ]
...
class RcsData(ctypes.Structure):
    ...
    _fields_ = [
        ...
        ("current_mileage", ctypes.c_int32),  # 单位: cm
        ("total_mileage", ctypes.c_int32),  # 单位: cm
        ("current_run_time", ctypes.c_long),  # 单位: s
        ("total_run_time", ctypes.c_long),  # 单位: s
        ("current_motion_time", ctypes.c_long),  # 单位: s
        ("total_motion_time", ctypes.c_long),  # 单位: s
...
class MotionStateData(ctypes.Structure):
    ...
    _fields_ = [
        ...
        ("leg_odom_pos", ctypes.c_float * 3),  # [x, y, yaw]
        ("leg_odom_vel", ctypes.c_float * 3),  # [x_vel, y_vel, yaw_vel]
